...
# 5.5 - check that the links go to the right pages
...
# 9.25 - test for signin/signout links in site layout
...
#Should also check for a link NOT being there.
